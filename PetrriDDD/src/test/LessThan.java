...
public class LessThan extends SimpleExpression{

	public LessThan(String var, Integer val, DD<String, Integer> ddd) {
		super(var, val, ddd);
	...
	protected DD<String, Integer> operate(String var, Integer val, DD<String, Integer> ddd) {
		...
		Hom<String, Integer> lessThan = new SimplePropagationDDDHomImpl<String, Integer>() {
